...
return [
    ...
    // Months & Days
    'month_01' => 'January', 'month_02' => 'February', 'month_03' => 'March', 'month_04' => 'April', 'month_05' => 'May', 'month_06' => 'June',
    'month_07' => 'July', 'month_08' => 'August', 'month_09' => 'September', 'month_10' => 'October', 'month_11' => 'November', 'month_12' => 'December',
    ...
    'mod_liste_name'     => 'Lists',
    'mod_liste_desc'     => 'Shared named lists — groceries, DIY, pharmacy… As many lists as needed.',
    ...
    // 4. SETTINGS
    // ==========================================
    'set_title_page'             => '⚙️ Settings',
    'set_title_lang'             => '🌐 Language',
    'set_title_modules'          => '🧩 Active Modules',
    'set_desc_modules'           => 'Choose the modules visible in the navigation.',
    'set_title_ios'              => '📱 iOS Calendar Integration (CalDAV)',
    'set_desc_ios'               => 'Configure your iCloud calendar here to sync events.',
    'set_label_apple_id'         => 'Apple ID (iCloud email)',
    'set_label_apple_pwd'        => 'Apple app password',
    'set_label_apple_url'        => 'CalDAV calendar URL',
    'set_btn_test_ios'           => 'Test connection',
    'set_btn_disconnect_ios'     => 'Disconnect',
    'set_title_bg'               => '🖼️ Home Image',
    'set_desc_bg'                => 'Background photo displayed on the homepage.',
    'set_badge_custom_bg'        => 'Custom image',
    'set_label_new_bg'           => 'New image (jpg, png, webp — max 10 MB)',
    'set_btn_reset_bg'           => '🔄 Reset to default image',
    'set_confirm_reset_bg'       => 'Revert to default image?',
    'set_title_profile'          => '👤 My Profile',
    'set_label_username'         => 'Username',
    'set_label_display_name'     => 'First name / Display name',
    'set_label_profile_color'    => 'My profile theme color',
    'set_desc_profile_color'     => 'This color will be used for your budget grids, calendars, and personal indicators.',
    'set_title_pwd'              => '🔒 Change Password',
    'set_label_cur_pwd'          => 'Current password',
    'set_label_new_pwd'          => 'New password',
    'set_label_confirm_pwd'      => 'Confirm',
    'set_btn_edit'               => 'Edit',
    'set_title_family'           => '🏠 My Family Space',
    'set_label_family_name'      => 'Space name',
    'set_desc_invite'            => 'Invitation code — share it to invite someone',
    'set_title_copy'             => 'Click to copy',
    'set_msg_copied'             => '✓ Copied!',
    'set_btn_new_code'           => '🔄 New code',
    'set_confirm_new_code'       => 'Regenerate code? The old one will be invalidated.',
    'set_desc_register_link'     => 'Registration link:',
    'set_title_members'          => 'Members',
    'set_badge_admin'            => 'Admin',
    'set_title_attached'         => '🧸 Attached Profiles',
    'set_desc_attached'          => 'Household members without direct access.',
    'set_empty_attached'         => 'No attached profiles.',
    'set_link_admin'             => '→ Administration Panel',
    ...
    'set_add_care_mode'          => 'Add a mode',
    
    // Labels Profiles
    'label_firstname'            => 'First Name',
    'placeholder_firstname_ex'   => 'e.g., Pol, Carole...',
    'label_role'                 => 'Role',
    'role_child'                 => '👶 Child',
    'role_child_icon'            => '👶 Child',
    'role_helper'                => '💼 Helper',
    'role_helper_icon'           => '💼 Helper',
    'role_relative'              => '👵 Relative',
    'role_relative_icon'         => '👵 Relative',
    'role_unknown'               => 'Unknown',
    'label_color'                => 'Color',
    'change_color'               => 'Change color',
    'confirm_delete_profile'     => 'Permanently delete this profile?',
    
    // Settings Messages
    'error_csrf'                 => 'Invalid session (CSRF). Please reload the page.',
    'set_err_min_module'         => 'You must keep at least one active module.',
    'set_success_modules'        => 'Modules successfully updated.',
    'set_success_lang'           => 'Language updated.',
    'set_err_empty_name'         => 'First name cannot be empty.',
    'set_success_profile'        => 'Profile updated successfully.',
    'set_err_wrong_pwd'          => 'Incorrect current password.',
    'set_err_pwd_length'         => 'New password must be at least 6 characters long.',
    'set_err_pwd_match'          => 'Passwords do not match.',
    'set_success_pwd'            => 'Password successfully changed.',
    'set_success_family'         => 'Space name updated.',
    'set_success_invite'         => 'New invitation code generated.',
    'set_err_bg_format'          => 'Unsupported format (jpg, png, webp).',
    'set_success_bg'             => 'Home image updated.',
    'set_err_upload'             => 'Error during upload.',
    'set_success_bg_reset'       => 'Home image reset.',
    'set_err_db_unavailable'     => 'Family database unavailable.',
    'set_err_ios_missing'        => 'Please provide an iCloud ID, app password, and CalDAV URL.',
    'set_success_ios'            => 'iOS calendar connection saved.',
    'set_success_ios_auto'       => ' Calendar URL automatically detected.',
    'set_err_ios_save'           => 'Cannot save iOS connection: ',
    'set_err_ios_none'           => 'No iOS connection configured.',
    'set_success_ios_test'       => 'Valid iCloud CalDAV connection (HTTP %s).',
    'set_err_ios_test'           => 'Connection test failed (HTTP %s). Check your credentials.',
    'set_err_ios_test_fail'      => 'Connection test unavailable: ',
    'set_success_ios_del'        => 'iOS connection removed.',
    'set_success_profile_add'    => 'Profile for %s successfully added.',
    'set_err_name_required'      => 'First name is required.',
    'set_success_profile_del'    => 'Profile deleted.',
    'set_success_color'          => 'Color updated!',
    'set_success_color_profile'  => 'Profile color updated.',
    'set_success_color_update'   => 'Color updated!',
    'color_updated'              => 'Color updated!',
    'settings_profile_added'     => 'Profile of %s added successfully.',
    'settings_err_name_required' => 'First name is required.',
    'settings_attached_profiles_title' => 'Attached Profiles',
    'settings_attached_profiles_desc'  => 'Household members without direct access.',
    'settings_no_attached_profiles'    => 'No attached profiles.',
    'placeholder_apple_id'       => 'name@icloud.com',
    ...
    'fc_clear'                  => 'Clear',
    'fc_menu_kids_leaves'       => 'Parent\'s Leave',
    ...
    'fc_err_select_leave'       => 'Please select a leave type.',
    ...
    'fc_helper_recap'           => 'Helper Summary',
    'fc_no_helper_leaves'       => 'No leaves taken this month.',
    'fc_col_date'               => 'Date',
    'fc_col_type'               => 'Type',
    'fc_col_duration'           => 'Duration',
    ...
    'fc_confirm_del_catalog'    => 'Permanently delete leave %s from the catalog? This will also remove it from members using it.',
    'fc_confirm_del_member_leave'=> 'Do you really want to remove this leave for this member?',
    ...
    'btn_off'                   => 'Off',
    'btn_extra'                 => 'Extra',
    'fc_alert_burn_days'        => '⚠️ Risk of losing: %s d to take before end of cycle',
    'fc_alert_burn_jra'         => '⚠️ Alert: Carried over days expire at the end of this month!',
    ...
    'bud_dyn_nanny_fixed'      => 'Nanny fixed salary (€)',
    'bud_dyn_nanny_daily'      => 'Daily maintenance fee (€)',
    'bud_dyn_nanny_aid'        => 'Government aid (€)',
    'bud_dyn_nanny_cesu_avg'   => 'Average CESU paid (€)',
    'bud_dyn_school_meal'      => 'School meal price (€)',
    'bud_dyn_school_aftercare' => 'After-school care price (€)',
    'bud_dyn_school_fullday'   => 'Full day care (Wednesdays/Holidays) (€)',
    'bud_dyn_pattern_title'    => 'Standard school week',
    'bud_audit_month'      => 'Analyzed month: %02d/%d',
    'bud_audit_nanny_abs'  => '%s absences deducted : %dd',
    'bud_audit_child'      => '👦 %s :',
    'bud_audit_school_fee' => 'Canteen (%dd) + Aftercare (%dd) + Center (%dd) = %.2f€',
    'bud_audit_sick'       => 'Sick days deducted : %dd',
    'bud_audit_nanny_full'   => '💼 %s : Fixed (%.2f€) + Fees (%dd x %.2f€ = %.2f€) - Aid (%.2f€) - %s (%.2f€) = %.2f€',
    'bud_audit_cesu_avg'     => 'CESU (Avg.)',
    'bud_audit_cesu_adj'     => 'CESU (Adjusted)',
    'bud_dyn_cesu_overrides' => 'Specific CESU adjustments',
    'bud_dyn_cesu_add'       => 'Add a month',
    'bud_dyn_cesu_empty'     => 'No adjustments recorded.',
    'bud_settings_dyn_title' => 'Care & School',
    'bud_settings_dyn_desc'  => 'Rates for automated childcare fee calculations.',
    'bud_dyn_sub_nanny'      => 'Nanny',
    'bud_dyn_sub_school'     => 'Afterschool & Center',
    ...
    'bud_select_beneficiary'    => 'Choose an expected income',
    ...
    'bud_sav_new_line'             => 'New line',
    'bud_sav_prompt_new_line'      => 'Name of the new savings line:',
    ...
    // Budget : Provisions & Optimization
    ...
    'gift_modal_title_add'           => 'Add for %s',
    ...
    'gift_settings_empty'            => 'No occasion configured.',
    'gift_settings_active'           => 'Active',
    ...
    // 10. LISTS & GROCERIES
    // ==========================================
    'liste_placeholder_add'      => 'Add an item...',
    'liste_btn_add'              => 'Add',
    'liste_btn_uncheck_all'      => 'Uncheck all',
    'liste_btn_delete_picked'    => 'Delete checked items',
    'liste_btn_clear_all'        => 'Clear list',
    'liste_subtitle'             => '{pending} to do · {cart} checked',
    'liste_added'                => 'Added',
    'liste_updated'              => 'Updated',
    'liste_deleted'              => 'Deleted',
    'liste_already_in'           => 'Already in the list',
    'liste_confirm_clear'        => 'Clear the entire list?',
    'liste_confirm_delete_list'  => 'Delete this list and all its items?',
    'liste_history_title'        => 'Recently used — click to add',
    'liste_new_list'             => 'New list',
    'liste_list_name_placeholder'=> 'List name...',
    'liste_create'               => 'Create',
    'liste_rename_list'          => 'Rename',
    'liste_new_name'             => 'New name:',
    'liste_list_deleted'         => 'List deleted',
    'liste_list_created'         => 'List created',
    'liste_list_renamed'         => 'List renamed',
    'liste_edit_placeholder'     => 'Edit item:',
    'liste_empty_state'          => 'Create your first list using the + button above.',
    'liste_settings_title'       => 'Lists — history',
    'liste_settings_intro'       => 'Maximum number of items remembered in history (shared across lists).',
    'liste_settings_history_max' => 'History size',
    'liste_settings_history_hint'=> 'Between 1 and 50.',
    'groceries_settings_saved'   => 'Preferences saved.',
    'groceries_settings_error'   => 'Could not save:',
    'groceries_err_duplicate'    => 'This product is already on the list.',

    // --- MODULE MEALS ---
    'menu_meals'          => 'Meals',
    'mod_meals_name'      => 'Meal Plan',
    'mod_meals_desc'      => 'Plan weekly meals for the whole family.',
    'meals_board_title'   => 'Meal Planner',
    'meals_copy_lunch'    => 'Copy entire lunch',
    'meals_copy_dinner'   => 'Copy entire dinner',
    'meal_lunch'          => 'Lunch',
    'meal_dinner'         => 'Dinner',
    'btn_apply_all'       => 'All',
    'btn_copy_to'         => 'Copy to...',
    'modal_copy_title'    => 'Copy to...',
    'source_individual'   => 'Individual meal',
    'source_row'          => 'Full meal',
    'week_current'        => 'Current week',
    'week_next'           => 'Next week',
    'meals_no_members'    => 'Please configure family members in the settings.',
    'day_full_mon' => 'Monday', 'day_full_tue' => 'Tuesday', 'day_full_wed' => 'Wednesday',
    'day_full_thu' => 'Thursday', 'day_full_fri' => 'Friday', 'day_full_sat' => 'Saturday', 'day_full_sun' => 'Sunday',
    'meal_title' => 'Meal Planner',
    'meal_edit_title' => 'Edit meal',
    'meal_label_name' => 'Planned menu',
    'meal_ph_name' => 'E.g. Homemade lasagna',
    'meal_week' => 'Week',
    'meal_empty_slot' => 'To be defined...',
    'meal_current_week' => 'Current week',
    'meal_saved' => 'Meal saved!',
    'meal_btn_import_pdf' => 'Import Menu PDF',
    'meal_import_title' => 'Import canteen menu',
    'meal_import_child' => 'For which person?',
    ...
    'mod_food_name' => 'Kitchen & Groceries',
    'food_tab_meals' => 'Weekly Menu',
    'food_tab_list' => 'Shopping List',
    'menu_food' => 'Food',
