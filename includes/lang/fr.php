...
return [
    ...
    'groceries_placeholder_add' => 'Ex : lait, pain, tomates…',
    'groceries_btn_add'  => 'Ajouter',
    'groceries_btn_uncheck_all' => 'Tout remettre à prendre',
    'groceries_btn_delete_picked' => 'Retirer du caddie (supprimer)',
    'groceries_subtitle' => '{pending} à prendre · {cart} dans le caddie',
    'groceries_added' => 'Ajouté',
    'groceries_updated' => 'Mis à jour',
    'groceries_deleted' => 'Supprimé',
    'groceries_reset_next' => 'Liste prête pour la prochaine sortie',
    'groceries_picked_removed' => 'Articles retirés',
    'groceries_label_empty' => 'Libellé vide',
    'groceries_confirm_del_title' => 'Supprimer ?',
    'groceries_confirm_del_body' => 'Retirer ce produit de la liste ?',
    'groceries_confirm_uncheck_title' => 'Tout remettre à prendre',
    'groceries_confirm_uncheck_body' => 'Les coches « dans le caddie » seront effacées. Les produits restent dans la liste.',
    'groceries_confirm_clear_title' => 'Retirer les produits du caddie',
    'groceries_confirm_clear_body' => 'Tous les articles cochés seront supprimés de la liste.',
    'groceries_empty' => 'Rien pour le moment. Ajoutez un produit ci-dessus.',
    'groceries_aria_toggle' => 'Marquer comme dans le caddie ou à prendre',
    'groceries_section_pending' => 'À prendre',
    'groceries_section_cart' => 'Dans le caddie',
    'groceries_prompt_edit' => 'Modifier le produit',
    'groceries_btn_clear_list' => 'Vider la liste',
    'groceries_confirm_empty_list_title' => 'Vider toute la liste ?',
    'groceries_confirm_empty_list_body' => 'Tous les produits seront retirés. Ils resteront disponibles dans l’historique pour les rajouter vite.',
    'groceries_list_cleared' => 'Liste vidée',
    'groceries_history_title' => 'Historique — un clic pour rajouter',
    'groceries_history_empty' => 'L’historique se remplit au fur et à mesure des produits ajoutés (jusqu’à la limite définie dans les paramètres).',
    'groceries_history_meta' => 'Jusqu’à {max} produits · ',
    'groceries_settings_link' => 'Réglages dans Paramètres',
    'groceries_settings_title' => 'Liste de courses — historique',
    'groceries_settings_intro' => 'Nombre maximum de produits mémorisés dans l’historique (sans doublon, insensible à la casse).',
    'groceries_settings_history_max' => 'Taille de l’historique',
    'groceries_settings_history_hint' => 'Entre 1 et 50. Les entrées les plus anciennes sont supprimées quand la limite est dépassée.',
