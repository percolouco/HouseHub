<?php
// Dictionnaire Français - HouseHub (Optimisé & Dédupliqué)
return [
    // ==========================================
    ...
    // Mois & Jours
    'month_01' => 'Janvier', 'month_02' => 'Février', 'month_03' => 'Mars', 'month_04' => 'Avril', 'month_05' => 'Mai', 'month_06' => 'Juin',
    'month_07' => 'Juillet', 'month_08' => 'Août', 'month_09' => 'Septembre', 'month_10' => 'Octobre', 'month_11' => 'Novembre', 'month_12' => 'Décembre',
    ...
    // ==========================================
    'set_title_page'             => '⚙️ Paramètres',
    'set_title_lang'             => '🌐 Langue / Language',
    'set_title_modules'          => '🧩 Modules actifs',
    'set_desc_modules'           => 'Choisissez les modules visibles dans la navigation.',
    'set_title_ios'              => '📱 Intégration Calendrier iOS (CalDAV)',
    'set_desc_ios'               => 'Configurez ici votre calendrier iCloud pour synchroniser les événements.',
    'set_label_apple_id'         => 'Identifiant Apple (email iCloud)',
    'set_label_apple_pwd'        => 'Mot de passe d\'app Apple',
    'set_label_apple_url'        => 'URL du calendrier CalDAV',
    'set_btn_test_ios'           => 'Tester la connexion',
    'set_btn_disconnect_ios'     => 'Déconnecter',
    'set_title_bg'               => '🖼️ Image d\'accueil',
    'set_desc_bg'                => 'Photo de fond affichée sur la page d\'accueil.',
    'set_badge_custom_bg'        => 'Image personnalisée',
    'set_label_new_bg'           => 'Nouvelle image (jpg, png, webp — max 10 Mo)',
    'set_btn_reset_bg'           => '🔄 Remettre l\'image par défaut',
    'set_confirm_reset_bg'       => 'Revenir à l\'image par défaut ?',
    'set_title_profile'          => '👤 Mon profil',
    'set_label_username'         => 'Nom d\'utilisateur',
    'set_label_display_name'     => 'Prénom / Pseudo affiché',
    'set_label_profile_color'    => 'Couleur thématique de mon profil',
    'set_desc_profile_color'     => 'Cette couleur sera utilisée pour vos grilles de budget, calendriers et indicateurs personnels.',
    'set_title_pwd'              => '🔒 Changer le mot de passe',
    'set_label_cur_pwd'          => 'Mot de passe actuel',
    'set_label_new_pwd'          => 'Nouveau mot de passe',
    'set_label_confirm_pwd'      => 'Confirmer',
    'set_btn_edit'               => 'Modifier',
    'set_title_family'           => '🏠 Mon espace familial',
    'set_label_family_name'      => 'Nom de l\'espace',
    'set_desc_invite'            => 'Code d\'invitation — partagez-le pour inviter quelqu\'un',
    'set_title_copy'             => 'Cliquer pour copier',
    'set_msg_copied'             => '✓ Copié !',
    'set_btn_new_code'           => '🔄 Nouveau code',
    'set_confirm_new_code'       => 'Regénérer le code ? L\'ancien sera invalidé.',
    'set_desc_register_link'     => 'Lien d\'inscription :',
    'set_title_members'          => 'Membres',
    'set_badge_admin'            => 'Admin',
    'set_title_attached'         => '🧸 Profils rattachés',
    'set_desc_attached'          => 'Membres gérés par le foyer n\'ayant pas d\'accès direct.',
    'set_empty_attached'         => 'Aucun profil rattaché.',
    'set_link_admin'             => '→ Panneau d\'administration',
    ...
    'label_role'                 => 'Rôle',
    'role_child'                 => '👶 Enfant',
    'role_child_icon'            => '👶 Enfant',
    'role_helper'                => '💼 Intervenant',
    'role_helper_icon'           => '💼 Intervenant',
    'role_relative'              => '👵 Proche',
    'role_relative_icon'         => '👵 Proche',
    'role_unknown'               => 'Inconnu',
    'label_color'                => 'Couleur',
    'change_color'               => 'Changer la couleur',
    'confirm_delete_profile'     => 'Supprimer définitivement ce profil ?',
    
    // Messages Settings
    'error_csrf'                 => 'Session invalide (CSRF). Rechargez la page.',
    'set_err_min_module'         => 'Vous devez garder au moins un module actif.',
    'set_success_modules'        => 'Modules mis à jour avec succès.',
    'set_success_lang'           => 'Langue mise à jour.',
    'set_err_empty_name'         => 'Le prénom ne peut pas être vide.',
    'set_success_profile'        => 'Profil mis à jour avec succès.',
    'set_err_wrong_pwd'          => 'Mot de passe actuel incorrect.',
    'set_err_pwd_length'         => 'Le nouveau mot de passe doit faire au moins 6 caractères.',
    'set_err_pwd_match'          => 'Les mots de passe ne correspondent pas.',
    'set_success_pwd'            => 'Mot de passe modifié avec succès.',
    'set_success_family'         => 'Nom de l\'espace mis à jour.',
    'set_success_invite'         => 'Nouveau code d\'invitation généré.',
    'set_err_bg_format'          => 'Format non supporté (jpg, png, webp).',
    'set_success_bg'             => 'Image d\'accueil mise à jour.',
    'set_err_upload'             => 'Erreur lors de l\'upload.',
    'set_success_bg_reset'       => 'Image d\'accueil réinitialisée.',
    'set_err_db_unavailable'     => 'Base famille indisponible.',
    'set_err_ios_missing'        => 'Merci de renseigner identifiant iCloud, mot de passe d\'app et URL CalDAV.',
    'set_success_ios'            => 'Connexion calendrier iOS enregistrée.',
    'set_success_ios_auto'       => ' URL du calendrier détectée automatiquement.',
    'set_err_ios_save'           => 'Impossible d\'enregistrer la connexion iOS : ',
    'set_err_ios_none'           => 'Aucune connexion iOS configurée.',
    'set_success_ios_test'       => 'Connexion iCloud CalDAV valide (HTTP %s).',
    'set_err_ios_test'           => 'Test connexion échoué (HTTP %s). Vérifiez vos identifiants.',
    'set_err_ios_test_fail'      => 'Test connexion impossible : ',
    'set_success_ios_del'        => 'Connexion iOS supprimée.',
    'set_success_profile_add'    => 'Profil de %s ajouté avec succès.',
    'set_err_name_required'      => 'Le prénom est obligatoire.',
    'set_success_profile_del'    => 'Profil supprimé.',
    'set_success_color'          => 'Couleur mise à jour !',
    'set_success_color_profile'  => 'Couleur du profil mise à jour.',
    'set_success_color_update'   => 'Couleur mise à jour !',
    'color_updated'              => 'Couleur mise à jour !',
    'settings_profile_added'     => 'Profil de %s ajouté avec succès.',
    'settings_err_name_required' => 'Le prénom est obligatoire.',
    'settings_attached_profiles_title' => 'Profils rattachés',
    'settings_attached_profiles_desc'  => 'Membres gérés par le foyer (Enfants, Nounous, Proches) n\'ayant pas d\'accès direct.',
    'settings_no_attached_profiles'    => 'Aucun profil rattaché.',
    'placeholder_apple_id'       => 'nom@icloud.com',
    'placeholder_apple_pwd'      => 'xxxx-xxxx-xxxx-xxxx',

    // ==========================================
    // 5. CALENDRIER FAMILIAL
    // ==========================================
    ...
    'fc_clear'                  => 'Effacer',
    'fc_menu_kids_leaves'       => 'Congés Parents',
    ...
    'fc_err_select_leave'       => 'Veuillez sélectionner un type de congé.',
    'fc_today_short'            => 'Auj.',
    ...
    'fc_helper_recap'           => 'Récapitulatif Intervenant',
    'fc_no_helper_leaves'       => 'Aucun congé posé ce mois-ci.',
    'fc_col_date'               => 'Date',
    'fc_col_type'               => 'Type',
    'fc_col_duration'           => 'Durée',
    ...
    'fc_confirm_del_catalog'    => 'Supprimer définitivement le congé %s du catalogue ? Cela le retirera également des membres qui l\'utilisent.',
    'fc_confirm_del_member_leave'=> 'Voulez-vous vraiment retirer ce congé pour ce membre ?',
    ...
    'btn_off'                   => 'Off',
    'btn_extra'                 => 'Extra',
    'fc_alert_burn_days'        => '⚠️ Risque de perte : %s j à poser avant la fin de cycle',
    'fc_alert_burn_jra'         => '⚠️ Alerte : Jours reportés expirent à la fin de ce mois !',
    ...
    // Anciennes clés (conservées au cas où)
    'outbound_trip'             => 'Aller',
    'return_trip'               => 'Retour',
    'period'                    => 'Période',
    ...
    'bud_dyn_nanny_fixed'      => 'Salaire fixe Assistante Maternelle (€)',
    'bud_dyn_nanny_daily'      => 'Frais d\'entretien journaliers (€)',
    'bud_dyn_nanny_aid'        => 'Aide de l\'État (CMG) (€)',
    'bud_dyn_nanny_cesu_avg'   => 'Moyenne CESU versée (€)',
    'bud_dyn_school_meal'      => 'Prix repas Cantine (€)',
    'bud_dyn_school_aftercare' => 'Prix Accueil Périscolaire soir (€)',
    'bud_dyn_school_fullday'   => 'Prix Accueil Journée (Mercredi/Vacances) (€)',
    'bud_dyn_pattern_title'    => 'Semaine type d\'école',
    'bud_audit_month'      => 'Mois analysé : %02d/%d',
    'bud_audit_nanny_abs'  => 'Absences %s déduites : %dj',
    'bud_audit_child'      => '👦 %s :',
    'bud_audit_school_fee' => 'Cantine (%dj) + Garderie (%dj) + Centre (%dj) = %.2f€',
    'bud_audit_sick'       => 'Jours maladie déduits : %dj',
    'bud_audit_nanny_full'   => '💼 %s : Fixe (%.2f€) + Frais (%dj x %.2f€ = %.2f€) - CMG (%.2f€) - %s (%.2f€) = %.2f€',
    'bud_audit_cesu_avg'     => 'CESU (Moy.)',
    'bud_audit_cesu_adj'     => 'CESU (Ajusté)',
    'bud_dyn_cesu_overrides' => 'Ajustements ponctuels du CESU',
    'bud_dyn_cesu_add'       => 'Ajouter un mois',
    'bud_dyn_cesu_empty'     => 'Aucun ajustement enregistré.',
    'bud_settings_dyn_title' => 'Garde & École',
    'bud_settings_dyn_desc'  => 'Tarifs pour le calcul automatisé des frais de garde.',
    'bud_dyn_sub_nanny'      => 'Nounou',
    'bud_dyn_sub_school'     => 'Périscolaire',
    ...
    'bud_sav_new_line'             => 'Nouvelle ligne',
    'bud_sav_prompt_new_line'      => 'Nom de la nouvelle ligne d\'épargne :',
    ...
    'gift_modal_title_add'           => 'Ajouter pour %s',
    ...
    'gift_settings_empty'            => 'Aucune fête configurée.',
    'gift_settings_active'           => 'Actif',
    ...
    // --- MODULE MEALS ---
    'menu_meals'          => 'Repas',
    'mod_meals_name'      => 'Menus',
    'mod_meals_desc'      => 'Planifiez les repas de la semaine pour toute la famille.',
    'meals_board_title'   => 'Planning Repas',
    'meals_copy_lunch'    => 'Copier le midi entier',
    'meals_copy_dinner'   => 'Copier le soir entier',
    'meal_lunch'          => 'Midi',
    'meal_dinner'         => 'Soir',
    'btn_apply_all'       => 'Tous',
    'btn_copy_to'         => 'Copier vers...',
    'modal_copy_title'    => 'Copier vers...',
    'source_individual'   => 'Plat individuel',
    'source_row'          => 'Repas complet',
    'week_current'        => 'Semaine actuelle',
    'week_next'           => 'Semaine prochaine',
    'meals_no_members'    => 'Veuillez configurer les membres de votre famille dans les paramètres.',
    'day_full_mon' => 'Lundi', 'day_full_tue' => 'Mardi', 'day_full_wed' => 'Mercredi',
    'day_full_thu' => 'Jeudi', 'day_full_fri' => 'Vendredi', 'day_full_sat' => 'Samedi', 'day_full_sun' => 'Dimanche',
    'meal_title' => 'Planificateur de Repas',
    'meal_edit_title' => 'Modifier le repas',
    'meal_label_name' => 'Menu prévu',
    'meal_ph_name' => 'Ex: Lasagnes maison',
    'meal_week' => 'Semaine',
    'meal_empty_slot' => 'À définir...',
    'meal_current_week' => 'Semaine en cours',
    'meal_saved' => 'Repas enregistré !',
    'meal_btn_import_pdf' => 'Importer Menu PDF',
    'meal_import_title' => 'Importer un menu de cantine',
    'meal_import_child' => 'Pour quel enfant ?',
    'meal_select_child' => 'Sélectionner l\'enfant',
    'meal_pdf_file' => 'Fichier PDF (Convivio)',
    'meal_drop_pdf' => 'Cliquez pour ajouter le PDF',
    'meal_import_success' => 'Menus importés avec succès !',
    'mod_food_name' => 'Cuisine & Courses',
    'food_tab_meals' => 'Menu de la semaine',
    'food_tab_list' => 'Liste de courses',
    'menu_food' => 'Food',
